...
@section('content')
    <div class="d-flex flex-column flex-root">
        ...
        <div
            ...
            style="background-image: url({{ asset(theme()->getIllustrationUrl('bg.png')) }});     background-size: auto;">

            <!--begin::Content-->
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                <a href="{{ $theme->getPageUrl('index') }}" class="mb-12">
                    <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/ladylike.png') }}" class="h-45px"/>
                </a>
                <!--end::Logo-->
